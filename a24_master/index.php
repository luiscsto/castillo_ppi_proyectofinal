...
<body class="animsition">
						...
						<div class="menu-desktop">
							<ul class="main-menu">
								<li>
									...
									<ul class="sub-menu">
										<li><a href="product.php">Ropa</a></li>
										<li><a href="prodcut.php">Coleccionables</a></li>
										<li><a href="product.php">Libros</a></li>
										<li><a href="product.php">Hogar</a></li>
									</ul>
								</li>
	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1" style="background-image: url(images/slides_a24_2.png);">
					...
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							...
							<div class="layer-slick1 animated visible-false" data-appear="slideInUp" data-delay="1600">
								<a href="product.php" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn3 p-lr-15 trans-04">
									Shop Now
								</a>
							</div>
						</div>
						...
						<div class="p-l-25 p-r-30 p-lr-0-lg">
							<div class="wrap-slick3 flex-sb flex-w">
								...
								<div class="slick3 gallery-lb">
									<div class="item-slick3" data-thumb="images/a24-towel.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="images/a24-towel.jpg" alt="IMG-PRODUCT">

											<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="images/a24-towel.jpg">
												<i class="fa fa-expand"></i>
											</a>
										</div>
									</div>

									<div class="item-slick3" data-thumb="images/a24-towel-2.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="images/a24-towel-2.jpg" alt="IMG-PRODUCT">

											<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="images/a24-towel-2.jpg">
												<i class="fa fa-expand"></i>
											</a>
										</div>
									</div>

									<div class="item-slick3" data-thumb="images/a24-towel-3.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="images/a24-towel-3.jpg" alt="IMG-PRODUCT">

											<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="images/a24-towel-3.jpg">
												<i class="fa fa-expand"></i>
											</a>
										</div>
									</div>
